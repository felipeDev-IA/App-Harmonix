...
const LoginView: React.FC<LoginViewProps> = ({ onAuthSuccess }) => {
  ...
  const REQUIRED_DOMAIN = '@gmail.com';
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 p-8 rounded-[3rem] shadow-2xl space-y-6 animate-in zoom-in-95 duration-500">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {error && (
              <div className={`p-4 rounded-2xl text-[11px] font-bold animate-in shake duration-300 border ${error.code === 'EMAIL_NOT_CONFIRMED'
                  ...
                  <div className="space-y-1">
                    ...
                    {error.code === 'EMAIL_NOT_CONFIRMED' && (
                      <p className="font-normal opacity-80 leading-relaxed">
                        Como você está usando {REQUIRED_DOMAIN}, desative a opção <b>"Confirm email"</b> nas configurações de Auth do Supabase se quiser logar sem verificação.
                      </p>
                    )}
                  </div>
                </div>
